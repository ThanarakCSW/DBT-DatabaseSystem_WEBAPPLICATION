      ...
      <div class="layout-container">
        ...
        <div class="form-row row">
            ...
            <div class="col-md-6">
                ...
                <input name="price" type="number"  class="form-control" id="price" value="<?php echo $row['price'];?>" readonly="readonly">
            </div>
        </div>
  ...
  <tbody>
    <tr>
      ...
      <td width="56%" align="center"><strong>จำนวน</strong></td>
	   ...
	   <?php
                              $sql4 = "SELECT `nr`, `room` FROM `numroom_low` WHERE `sum_id`=$eid";
      ...
      <div class="modal-content">
        ...
        <div class="form-row row">
            <div class="col-md-12 text-center">
                ...
                <a href="screqlow.php?scr=<?php echo $eid2; ?>">
