              ...
              <div class="row">
                ...
                <!-- Total Revenue -->
                  ...
                  <div class="card">
                    ...
                    ?>
                 <form action="actions/editeqlow2.php?eid=<?php echo $eid; ?>" method="post" enctype="multipart/form-data">
        <!-- Row 1 -->
    ...
    <div>
        ...
        if (mysqli_num_rows($result4) > 0) {
            while ($row4 = mysqli_fetch_assoc($result4)) {
                ...
                $sql_check = "SELECT nr FROM numroom_low WHERE room = '$room' AND sum_id = '$eid'";
