                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        ...
                        <h3 class="card-header m-0 me-2 pb-3"><strong>รายการข้อมูลครุภัณฑ์ตามเกณฑ์ : ผลการค้นหา <?php echo $scr; ?></strong></h3>
      ...
      <button type="button" class="btn btn-success">เพิ่ม</button>
                      ...
                      <table width="802" border="0" align="center" class="table table-hover" >
                        <tbody>
                          ...
                          <?php
						$scr = isset($_POST['scr']) ? $_POST['scr'] : (isset($_GET['scr']) ? $_GET['scr'] : null);
						  $n=1;
                          
$sql = "
    SELECT eq.*
    FROM eqnomal eq
    JOIN numroom nr ON eq.sum_id = nr.sum_id
...
";
                          ...
                          <tr>
                            ...
                            <td align="center" valign="middle"><div class="bootstrap-scope">
                              <a href="detailscrnomal.php?eid=<?php echo $row['sum_id'];?>&eid2=<?php echo $scr;?>">
