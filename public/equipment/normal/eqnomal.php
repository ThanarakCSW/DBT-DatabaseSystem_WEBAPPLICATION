...
>
  ...
  <!-- ค้นหา -->
  <div class="col-md-6">
    <form action="screqnomal.php" method="post" enctype="multipart/form-data" class="d-flex align-items-center gap-2">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <!-- แบบฟอร์มตัวกรอง -->
          <div class="col-md-2">
          <form  id="filterForm" action="actions/export_eqnomal.php" method="post">
    <!-- ตัวกรองผู้รับผิดชอบ -->
    <fieldset>
        <h6>เลือกผู้รับผิดชอบ</h6>
        <?php
...
$countQuery = "SELECT COUNT(*) AS total FROM `eqnomal`";
...
$totalPages = ceil($totalRecords / $limit);
              ...
              $where = "WHERE 1";
              $join = "LEFT JOIN numroom nr ON eq.sum_id = nr.sum_id";
              ...
              $countSQL = "SELECT COUNT(*) AS total FROM eqnomal eq $join $where";
              ...
              // ดึงข้อมูลหลัก
              $sql = "SELECT DISTINCT eq.* FROM eqnomal eq $join $where $orderBy LIMIT $limit OFFSET $offset";
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="actions/delnomalsupp.php?eid=<?php echo $row['sum_id'];?>">
...
document.getElementById('previewReportBtn').addEventListener('click', function () {
  ...
  fetch('actions/export_eqnomal.php', {
    method: 'POST',
    body: formData
  })
  .then(res => res.text())
