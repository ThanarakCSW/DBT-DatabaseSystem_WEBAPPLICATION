<nav class="layout-navbar container-fluid navbar navbar-expand-fluid navbar-detached align-items-center bg-navbar-theme"
    id="layout-navbar">
            ...
            <li class="nav-item navbar-dropdown dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar">
                        <img src="/eq/public/images/aA.png" alt class="w-px-40 h-px-40" />
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item" href="javascript:void(0);"
                            onclick="changeFontSize('decrease'); event.stopPropagation();">ลดขนาดตัวอักษร (-)</a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="javascript:void(0);"
                            onclick="changeFontSize('increase'); event.stopPropagation();">เพิ่มขนาดตัวอักษร (+)</a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="javascript:void(0);"
                            onclick="changeFontSize('reset'); event.stopPropagation();">ขนาดเริ่มต้น</a>
                    </li>
                    <li>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="/eq/public/images/logo.png" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item" href="#">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar avatar-online">
                                        <img src="/eq/public/images/logo.png" alt
                    ...
                    <li>
                        <a class="dropdown-item" href="/eq/public/actions/logout.php">
...
<style>
    ...
    textarea {
        ...
        /* ใช้ขนาดฟอนต์ที่กำหนดไว้ใน body */
    }
</style>
